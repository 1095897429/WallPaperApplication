...
public class LoveCreateEvent {
    ...
    /** 喜好 */
    public LoveCreateEvent( int position,boolean isLove) {
        this.isLove = isLove;
        this.position = position;
    }

    /** 全更新 */
    public LoveCreateEvent(int position, int page, boolean isReset, List<MulAdBean> mulAdBeanList) {
        this.position = position;
        this.page = page;
