...
public class LoveSearchEvent {
    ...
    /** 喜好 */
    public LoveSearchEvent( int position,boolean isLove) {
        this.isLove = isLove;
        this.position = position;
    }

    /** 全更新 */
    public LoveSearchEvent(int position, int page, boolean isReset, List<MulAdBean> mulAdBeanList) {
        this.position = position;
        this.page = page;
