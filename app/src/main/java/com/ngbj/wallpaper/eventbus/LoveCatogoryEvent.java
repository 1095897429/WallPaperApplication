 ...
 * 2018.12.26
 */
public class LoveCatogoryEvent {
    ...
    /** 喜好 */
    public LoveCatogoryEvent( int position,boolean isLove) {
        this.isLove = isLove;
        this.position = position;
    }

    /** 全更新 */
    public LoveCatogoryEvent(int position, int page, boolean isReset, List<MulAdBean> mulAdBeanList) {
        this.position = position;
        this.page = page;
