...
public class HistoryBeanDao extends AbstractDao<HistoryBean, Long> {
    ...
    */
    public static class Properties {
        ...
        public final static Property HistoryName = new Property(1, String.class, "historyName", false, "HISTORY_NAME");
        public final static Property ClickTime = new Property(2, String.class, "clickTime", false, "CLICK_TIME");
    };
    ...
    public static void createTable(Database db, boolean ifNotExists) {
        ...
        db.execSQL("CREATE TABLE " + constraint + "\"HISTORY_BEAN\" (" + //
                ...
                "\"HISTORY_NAME\" TEXT," + // 1: historyName
                "\"CLICK_TIME\" TEXT);"); // 2: clickTime
    }
    ...
    protected final void bindValues(DatabaseStatement stmt, HistoryBean entity) {
        ...
        if (historyName != null) {
            stmt.bindString(2, historyName);
        }
 
        String clickTime = entity.getClickTime();
        if (clickTime != null) {
            stmt.bindString(3, clickTime);
        }
    }
    ...
    public HistoryBean readEntity(Cursor cursor, int offset) {
        HistoryBean entity = new HistoryBean( //
            ...
            cursor.isNull(offset + 1) ? null : cursor.getString(offset + 1), // historyName
            cursor.isNull(offset + 2) ? null : cursor.getString(offset + 2) // clickTime
        );
        return entity;
    }
    ...
    public void readEntity(Cursor cursor, HistoryBean entity, int offset) {
        ...
        entity.setHistoryName(cursor.isNull(offset + 1) ? null : cursor.getString(offset + 1));
        entity.setClickTime(cursor.isNull(offset + 2) ? null : cursor.getString(offset + 2));
     }
