 ...
 * 预览 弹出框
 */
public class PreviewAlertDialog {
    ...
    public PreviewAlertDialog(Context context){
        mContext = context;
    ...
    public PreviewAlertDialog builder(){
...
//        lp.y = (int) (display.getWidth() * 0.0f);//设置Dialog距离底部的距离
    ...
    public PreviewAlertDialog setPreviewBeanList(List<String> list){
        this.mStrings = list;
        initRecycleView();
        return this;
    }
    ...
    public PreviewAlertDialog setCancelable(boolean cancel) {
    ...
    public PreviewAlertDialog setCanceledOnTouchOutside(boolean b) {
